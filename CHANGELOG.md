...
- **Spec-Kit Translator (`/spec_translator`)**: New additional feature for converting execution plans to spec-kit formatted documents
  - Automatically converts Plan files (generated by `/discuss`) into three spec-kit documents: constitution.md, specify.md, and plan.md
  - Designed for projects using [spec-kit](https://vibecoding.app/tools/spec-kit) for spec-driven development
  - Fully automatic conversion with intelligent mapping from Plan structure to spec-kit format
  - Integrated with discussion topics for automatic document linking

### Changed

- Updated documentation to include "Additional Features" section
- Installation and uninstallation scripts now include spec_translator command and rules
