...
A conversion tool for [Spec-Kit](https://github.com/jimmysong/spec-kit) workflow integration. Converts execution plans generated by `/discuss` into spec-kit formatted documents.
...
For more information about Spec-Kit, visit the [Spec-Kit repository](https://github.com/jimmysong/spec-kit).
