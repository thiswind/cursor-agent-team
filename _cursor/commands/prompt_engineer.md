...
```
[Phase 3 DONE] [LangGPT format prompt]
[Related files (if any)]
```

### Phase 4 Output: Wrap-up
```
[Phase 4 DONE] Confirm save? (Yes/No/Continue iteration)
```
