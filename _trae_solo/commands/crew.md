---
name: crew
description: Crew Member - Execution mode, strictly follow plans according to specifications.
---
...
## Phase 3: Wrap-up
- Record results: Update plan status to "completed" via `update_plan_status.py`, update `discussion_topics.md` execution record, format: `[Time] - /crew - [PlanID] - Execution completed (success/failed/partial)`
